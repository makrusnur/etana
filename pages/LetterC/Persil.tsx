    ...
    try {
      ...
      autoTable(doc, {
        ...
        styles: {
          ...
          lineWidth: 0.1,
          textColor: 0,
          overflow: 'linebreak' // Memastikan teks panjang tetap rapi
        },
        headStyles: {
        ...
        columnStyles: {
          0: { cellWidth: 12 }, // DINAIKKAN ke 12mm agar 3-4 digit tidak menumpuk
          1: { cellWidth: 20 },
          2: { cellWidth: 20 },
          3: { cellWidth: 55 }, 
          4: { cellWidth: 18 },
      ...
      doc.setFontSize(8);
      doc.setFont('helvetica', 'italic');
      // Ganti teks penutup sesuai permintaan
